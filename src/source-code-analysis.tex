...
Come accennato in apertura di questa Sezione, la source code analysis ricopre
...
Diverse  rappresentazioni interne vengono utilizzate dagli strumenti di source
...
Una semplificazione di questo processo può essere quella di estendere o
...
% ANALISI STATICA E ALTRI TIPI DI ANALISI

% Con il termine "analisi statica" di un programma si raccolgono tutti i tipi
% di analisi di un sistema software che vengono operati senza che questo venga
% eseguito. Nella grande maggioranza dei casi, tecniche di analisi statica
% vengono applicate a “codice sorgente”, termine utilizzato a partire dalla
% definizione precedentemente riportata.

% Tecniche di analisi statica vengono tipicamente applicate da uno strumento
% automatico; tecniche che prevedono lo svolgimento di un’analisi umana vengono
% chiamate definite di “program understanding”, “program comprehension” o “code
% review”.

% La complessità delle tecniche per l’analisi statica varia dalle tecniche che
% si limitano a considerare singole istruzioni e dichiarazione, a tecniche come
% fanno riferimento all’interno codice sorgente di un programma durante il loro
% svolgimento. Di conseguenza, anche gli usi delle informazioni che vengon
% ottenute attraverso l’applicazione delle diverse tecniche variano, dalla
% segnalazione di possibili errori di programmazione  (esempio, linters) fino a
% metodi per la verifica formale delle proprietà di un sistema.
